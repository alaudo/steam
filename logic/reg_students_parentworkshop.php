        <div class="row">
            <div class="form-group col-sm-12">
                <label class="checkbox-inline"><input name="withmychild" id="withmychild" type="checkbox" <?php utils::ifset($student,'is_parent_workshop','checked'); ?> >I am volunteering and I want my child to be in my workshop.</label>
            </div>
            <div class="alert alert-warning" role="alert">
            Please rank your workshop as Choice #1 if you want your child in your workshop.
            </div>
        </div>
        ...
        <div class="panel panel-success">
            ...
            <h4 class="panel-title">
                ...
                <span class="glyphicon glyphicon-chevron-down pull-right"></span> <small class="pull-right align=middle">Click arrow for details &nbsp;</small>  Parent workshop data
                </a>
            </h4>
            </div>
            ...
            <div class="panel-body">
                <div class="row control-group">
                    <div class="form-group col-sm-4 floating-label-form-group controls floating-label-form-group-with-value">
                ...
                <div class="row control-group">
                    <div class="form-group col-sm-8 floating-label-form-group controls floating-label-form-group-with-value">
                        <label>Email</label>
                ...
                <div class="row control-group">
                    <div class="form-group col-sm-12 floating-label-form-group controls floating-label-form-group-with-value">
